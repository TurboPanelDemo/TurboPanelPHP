...
#sudo ./configure --prefix=/usr/local/turbo/php \
#        --enable-fpm \
#        --with-fpm-user=admin \
...
PACKAGE_MAIN_DIR=$MAIN_DIR/turbo-php-8.2.0-$1
...
sudo mv /usr/local/turbo/php $PACKAGE_MAIN_DIR/usr/local/turbo
sudo cp $MAIN_DIR/php-fpm.conf $PACKAGE_MAIN_DIR/usr/local/turbo/php/etc
sudo mv $PACKAGE_MAIN_DIR/usr/local/turbo/php/sbin/php-fpm $PACKAGE_MAIN_DIR/usr/local/turbo/php/sbin/turbo-php-fpm

# Add php.ini file
sudo cp $MAIN_DIR/php.ini $PACKAGE_MAIN_DIR/usr/local/turbo/php/lib/php.ini
...
sudo dpkg --info $MAIN_DIR/turbo-php-8.2.0-$1.deb
sudo dpkg --contents $MAIN_DIR/turbo-php-8.2.0-$1.deb

# Move debian package to dist folder
sudo mkdir -p $MAIN_DIR/dist
sudo mv $MAIN_DIR/turbo-php-8.2.0-$1.deb $MAIN_DIR/dist
